...
PROTEINS = [
    ...
    {"id": "P:NPC1",  "name": "NPC intracellular cholesterol transporter 1", "xrefs": {"uniprot_id": "O15118"}},
    {"id": "P:NPC2",  "name": "NPC intracellular cholesterol transporter 2", "xrefs": {"uniprot_id": "P61916"}},
    {"id": "P:GAA",   "name": "Acid alpha-glucosidase",      "xrefs": {"uniprot_id": "P10253"}},
    {"id": "P:HEXA",  "name": "Beta-hexosaminidase subunit alpha", "xrefs": {"uniprot_id": "P06865"}},
    ...
    {"id": "P:CFTR",  "name": "Cystic fibrosis transmembrane conductance regulator", "xrefs": {"uniprot_id": "P13569"}},
    ...
    {"id": "P:MTOR",  "name": "Serine/threonine-protein kinase mTOR", "xrefs": {"uniprot_id": "P42345"}},
    {"id": "P:HSP70", "name": "Heat shock 70 kDa protein 1A","xrefs": {"uniprot_id": "P0DMV8"}},
]

DRUGS = [
    # Approved LSD therapies with approval years
    {"id": "DR:IMIGLUCERASE",   "name": "Imiglucerase",     "xrefs": {"drugcentral_id": "1423"},
     "approval_year": 1994, "is_approved": True},
    {"id": "DR:VELAGLUCERASE",  "name": "Velaglucerase alfa","xrefs": {"drugcentral_id": "4723"},
     "approval_year": 2010, "is_approved": True},
    {"id": "DR:TALIGLUCERASE",  "name": "Taliglucerase alfa","xrefs": {"drugcentral_id": "4829"},
     "approval_year": 2012, "is_approved": True},
    {"id": "DR:MIGLUSTAT",      "name": "Miglustat",         "xrefs": {"drugcentral_id": "1803"},
     "approval_year": 2003, "is_approved": True},  # approved for Gaucher T1 and NPC
    {"id": "DR:ELIGLUSTAT",     "name": "Eliglustat",        "xrefs": {"drugcentral_id": "4999"},
     "approval_year": 2014, "is_approved": True},
    {"id": "DR:AGALSIDASE_A",   "name": "Agalsidase alfa",   "xrefs": {"drugcentral_id": "4268"},
     "approval_year": 2001, "is_approved": True},  # EU
    {"id": "DR:AGALSIDASE_B",   "name": "Agalsidase beta",   "xrefs": {"drugcentral_id": "4267"},
     "approval_year": 2003, "is_approved": True},
    {"id": "DR:MIGALASTAT",     "name": "Migalastat",        "xrefs": {"drugcentral_id": "5158"},
     "approval_year": 2018, "is_approved": True},
    {"id": "DR:ALGLUCOSIDASE",  "name": "Alglucosidase alfa","xrefs": {"drugcentral_id": "4266"},
     "approval_year": 2006, "is_approved": True},
    {"id": "DR:LARONIDASE",     "name": "Laronidase",        "xrefs": {"drugcentral_id": "4269"},
     "approval_year": 2003, "is_approved": True},
    {"id": "DR:IDURSULFASE",    "name": "Idursulfase",       "xrefs": {"drugcentral_id": "4270"},
     "approval_year": 2006, "is_approved": True},
    {"id": "DR:ARIMOCLOMOL",    "name": "Arimoclomol",       "xrefs": {"drugcentral_id": "5492"},
     "approval_year": 2023, "is_approved": True},  # NPC, HSP co-inducer
    # Repurposing candidates (no TREATS edge — prediction targets)
    {"id": "DR:HPBCD",          "name": "2-hydroxypropyl-beta-cyclodextrin",
     "xrefs": {"drugcentral_id": "3094"}, "approval_year": None, "is_approved": False},
    {"id": "DR:VORINOSTAT",     "name": "Vorinostat",        "xrefs": {"drugcentral_id": "4383"},
     "approval_year": 2006, "is_approved": True},  # approved for CTCL, repurposing candidate for LSDs
    {"id": "DR:RAPAMYCIN",      "name": "Sirolimus (rapamycin)", "xrefs": {"drugcentral_id": "2438"},
     "approval_year": 1999, "is_approved": True},
    {"id": "DR:AMBROXOL",       "name": "Ambroxol",          "xrefs": {"drugcentral_id": "74"},
     "approval_year": 1979, "is_approved": True},  # approved as mucolytic; Gaucher chaperone candidate
    {"id": "DR:NAL",            "name": "N-acetyl-L-leucine","xrefs": {"drugcentral_id": None},
     "approval_year": 2024, "is_approved": True},  # recently approved for NPC
    # Non-LSD drugs for variety
    {"id": "DR:IVACAFTOR",      "name": "Ivacaftor",         "xrefs": {"drugcentral_id": "4835"},
     "approval_year": 2012, "is_approved": True},
    {"id": "DR:TETRABENAZINE",  "name": "Tetrabenazine",     "xrefs": {"drugcentral_id": "2627"},
     "approval_year": 2008, "is_approved": True},
]

PATHWAYS = [
    {"id": "PW:LYSO",      "name": "Lysosomal degradation",         "xrefs": {"reactome_id": "R-HSA-1632852"}},
    {"id": "PW:SPHINGO",   "name": "Sphingolipid metabolism",       "xrefs": {"reactome_id": "R-HSA-428157"}},
    {"id": "PW:GSL_BIOSYN","name": "Glycosphingolipid biosynthesis","xrefs": {"reactome_id": "R-HSA-9840310"}},
    {"id": "PW:GSL_DEG",   "name": "Glycosphingolipid degradation", "xrefs": {"reactome_id": "R-HSA-1663150"}},
    ...
    {"id": "PW:CHOLESTEROL","name": "Cholesterol transport",        "xrefs": {"reactome_id": "R-HSA-8957322"}},
    {"id": "PW:GAG_DEG",   "name": "Glycosaminoglycan degradation", "xrefs": {"reactome_id": "R-HSA-2024096"}},
...
SYMPTOMS = [
    ...
    {"id": "S:MOTORDECLINE",  "name": "Progressive motor deterioration","xrefs": {"hpo_id": "HP:0002344"}},
...
NODES = []
for d in DISEASES: NODES.append({**d, "type": "Disease"})
for g in GENES:    NODES.append({**g, "type": "Gene"})
for p in PROTEINS: NODES.append({**p, "type": "Protein"})
for dr in DRUGS:   NODES.append({**dr, "type": "Drug"})
for pw in PATHWAYS: NODES.append({**pw, "type": "Pathway"})
for s in SYMPTOMS: NODES.append({**s, "type": "Symptom"})
...
for sym in ["GBA", "GLA", "SMPD1", "NPC1", "NPC2", "GAA", "HEXA", "GALC",
            "IDUA", "IDS", "ARSA", "CFTR", "HTT"]:
...
for gp in ["GBA", "GLA", "SMPD1", "HEXA", "GALC", "IDUA", "IDS", "ARSA",
           "NPC1", "NPC2", "GAA"]:
...
DISEASE_PHENOTYPES = {
    "D:GAUCHER": ["HEPATOMEGALY", "SPLENOMEGALY", "BONEPAIN", "ANEMIA",
                  "THROMBOCYT"],
    "D:FABRY":   ["ANGIOKERATOMA", "RENAL", "NEUROPATHY", "CARDIOMYO",
                  "HEARINGLOSS", "CORNEACLOUD"],
    "D:NPA":     ["HEPATOMEGALY", "SPLENOMEGALY", "DEVDELAY", "CHERRYRED",
                  "HYPOTONIA", "MOTORDECLINE"],
    "D:NPB":     ["HEPATOMEGALY", "SPLENOMEGALY", "PULMONARY",
                  "THROMBOCYT"],
    "D:NPC":     ["HEPATOMEGALY", "SPLENOMEGALY", "VSGP", "ATAXIA",
                  "DYSTONIA", "DYSPHAGIA", "SEIZURES", "COGNITIVE",
                  "MOTORDECLINE"],
    "D:POMPE":   ["CARDIOMYO", "HYPOTONIA", "MOTORDECLINE", "HEARINGLOSS"],
    "D:TAYSACHS":["DEVDELAY", "CHERRYRED", "SEIZURES", "HYPOTONIA",
                  "MOTORDECLINE", "HEARINGLOSS"],
    "D:KRABBE":  ["DEVDELAY", "HYPOTONIA", "SEIZURES", "MOTORDECLINE",
                  "NEUROPATHY"],
    "D:MPS1":    ["COARSEFACE", "CORNEACLOUD", "SKELETAL", "HEARINGLOSS",
                  "DEVDELAY", "HEPATOMEGALY"],
    "D:MPS2":    ["COARSEFACE", "SKELETAL", "HEARINGLOSS", "HEPATOMEGALY",
                  "DEVDELAY"],
    "D:MLD":     ["MOTORDECLINE", "DEVDELAY", "NEUROPATHY", "SEIZURES",
                  "COGNITIVE"],
    "D:CF":      ["PULMONARY", "COGNITIVE"],   # toy, CF is not cognitive — keep simple
    "D:HD":      ["CHOREA", "DYSTONIA", "PSYCHIATRIC", "COGNITIVE",
                  "MOTORDECLINE"],
}
...
def main():
    ...
    payload = {
        ...
        "stats": {
            "n_nodes": len(NODES),
            "n_edges": len(edges),
            "by_node_type": {t: sum(1 for n in NODES if n["type"] == t)
                             for t in {n["type"] for n in NODES}},
            "by_rel_type": {r: sum(1 for e in edges if e["rel"] == r)
                            for r in {e["rel"] for e in edges}},
        },
    }
